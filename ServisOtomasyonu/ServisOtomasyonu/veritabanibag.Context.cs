...
namespace ServisOtomasyonu
{
    ...
    public partial class ServisOtomasyonuEntities : DbContext
    {
        public ServisOtomasyonuEntities()
            : base("name=ServisOtomasyonuEntities")
        {
        }
        ...
        public virtual DbSet<FaturaStok> FaturaStok { get; set; }
